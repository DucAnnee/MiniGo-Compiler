...
class ASTGenSuite(unittest.TestCase):
    def test_001(self):
        ...
        self.assertTrue(
            TestAST.checkASTGen(input, str(expect), inspect.stack()[0].function)
        )
                    ...
                    FuncCall(
                        ...
                        [
                            BinaryOp(
                                ...
                                BinaryOp(
                                    "-", IntLiteral(5), UnaryOp("-", IntLiteral(1))
                                ),
                            )
                        ],
                    ),
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    FuncCall(
                        "foo", [ArrayCell(Id("a"), [IntLiteral(2), IntLiteral(3)])]
                    ),
                )
            ]
        )
        ...
        expect = Program(
            [
                ConstDecl(
                    "VoTien",
                    None,
                    FuncCall("foo", [FieldAccess(FieldAccess(Id("a"), "b"), "c")]),
                )
            ]
        )
        self.assertTrue(
            ...
            [
                ConstDecl(
                    ...
                    FuncCall(
                        ...
                        [
                            FuncCall("a", []),
                            MethCall(Id("b"), "a", [IntLiteral(2), IntLiteral(3)]),
                        ],
                    ),
                )
            ]
            ...
            [
                ConstDecl(
                    ...
                    FuncCall(
                        "foo",
                        [
                            StructLiteral("Votien", []),
                            StructLiteral("Votien", [("a", IntLiteral(1))]),
                        ],
                    ),
                )
            ]
...
"""
        expect = Program(
            [
                FuncDecl("foo", [], IntType(), Block([Return(None)])),
                FuncDecl(
                    "foo",
                    ...
                    Block(
                        [
                            ForEach(
                                Id("index"),
                                Id("value"),
                                ArrayCell(Id("array"), [IntLiteral(2)]),
                                Block([Return(None)]),
                            )
                        ]
                    ),
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    ArrayLiteral(
                        [IntLiteral(1)], Id("ID"), [StructLiteral("Votien", [])]
                    ),
                )
            ]
        )
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    StructLiteral(
                        "ID", [("a", IntLiteral(1)), ("b", BooleanLiteral(True))]
                    ),
                )
            ]
        )
                    ...
                    StructLiteral(
                        ...
                        [
                            (
                                "a",
                                ArrayLiteral(
                                    [IntLiteral(1)], IntType(), [IntLiteral(1)]
                                ),
                            )
                        ],
                    ),
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    BinaryOp(
                        "-", BinaryOp("+", IntLiteral(0), IntLiteral(1)), IntLiteral(2)
                    ),
                )
            ]
        )
...
"""
        expect = Program(
            [
                ConstDecl(
                    "a", None, UnaryOp("!", UnaryOp("-", UnaryOp("!", IntLiteral(2))))
                )
            ]
        )
        self.assertTrue(
                    ...
                    BinaryOp(
                        ...
                        BinaryOp(
                            ...
                            BinaryOp(
                                ...
                                IntLiteral(4),
                                BinaryOp(
                                    "*", IntLiteral(5), UnaryOp("-", IntLiteral(6))
                                ),
                            ),
                        ),
                    ),
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    FieldAccess(
                        FieldAccess(FieldAccess(FieldAccess(Id("a"), "b"), "c"), "d"),
                        "e",
                    ),
                )
            ]
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    ArrayCell(
                        FieldAccess(StructLiteral("ID", []), "a"), [IntLiteral(2)]
                    ),
                )
            ]
        )
        ...
        expect = Program(
            [
                ConstDecl(
                    "a",
                    None,
                    MethCall(MethCall(MethCall(Id("a"), "b", []), "c", []), "d", []),
                )
            ]
        )
        self.assertTrue(
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    BinaryOp(
                        "*", Id("a"), BinaryOp("-", NilLiteral(), StringLiteral('"a"'))
                    ),
                )
            ]
        )
            ...
            [
                StructType(
                    ...
                    [
                        ("a", IntType()),
                        ("b", BoolType()),
                        ("c", ArrayType([IntLiteral(2)], Id("Votien"))),
                    ],
                    [],
                )
            ]
...
"""
        expect = Program(
            [
                InterfaceType(
                    "Votien", [Prototype("Add", [IntType(), IntType()], VoidType())]
                )
            ]
        )
        self.assertTrue(
                ...
                InterfaceType(
                    ...
                    [
                        Prototype(
                            ...
                            ArrayType([IntLiteral(2)], StringType()),
                        )
                    ],
                )
            ]
        ...
        expect = Program(
            [
                InterfaceType(
                    "Votien",
                    [
                        Prototype("Add", [], ArrayType([IntLiteral(2)], StringType())),
                        Prototype("Add", [], Id("ID")),
                    ],
                )
            ]
...
"""
        expect = Program(
            [
                FuncDecl(
                    "foo",
                    [ParamDecl("a", ArrayType([IntLiteral(2)], Id("ID")))],
                    VoidType(),
                    Block([Return(None)]),
                )
            ]
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [
                        ParamDecl("a", IntType()),
                        ParamDecl("b", ArrayType([IntLiteral(1)], IntType())),
                    ],
                    VoidType(),
                    Block([Return(None)]),
                )
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [
                        ParamDecl(
                            "a", ArrayType([Id("ID"), IntLiteral(2), Id("c")], Id("ID"))
                        ),
                        ParamDecl(
                            "b", ArrayType([Id("ID"), IntLiteral(2), Id("c")], Id("ID"))
                        ),
                        ParamDecl(
                            "c", ArrayType([Id("ID"), IntLiteral(2), Id("c")], Id("ID"))
                        ),
                        ParamDecl(
                            "d", ArrayType([Id("ID"), IntLiteral(2), Id("c")], Id("ID"))
                        ),
                    ],
                    VoidType(),
                    Block([Return(None)]),
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [],
                    VoidType(),
                    Block([ConstDecl("a", None, FloatLiteral("1."))]),
                )
            ]
        )
        self.assertTrue(
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [],
                    VoidType(),
                    Block([VarDecl("a", None, FloatLiteral("1."))]),
                )
            ]
        )
        self.assertTrue(
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            Assign(
                                ArrayCell(
                                    Id("a"), [StringLiteral('"s"'), FuncCall("foo", [])]
                                ),
                                ArrayCell(
                                    Id("a"),
                                    [IntLiteral(2), IntLiteral(2), IntLiteral(3)],
                                ),
                            ),
                            Assign(
                                ArrayCell(Id("a"), [IntLiteral(2)]),
                                ArrayCell(Id("a"), [IntLiteral(3), IntLiteral(4)]),
                            ),
                            Assign(
                                ArrayCell(
                                    FieldAccess(FieldAccess(Id("b"), "c"), "a"),
                                    [IntLiteral(2)],
                                ),
                                ArrayCell(
                                    FieldAccess(FieldAccess(Id("b"), "c"), "a"),
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [],
                    VoidType(),
                    Block([Assign(FieldAccess(Id("a"), "b"), IntLiteral(1))]),
                )
            ]
        )
        self.assertTrue(
                    ...
                    Block(
                        [
                            Assign(
                                FieldAccess(
                                    ArrayCell(
                                        FieldAccess(Id("a"), "b"), [IntLiteral(2)]
                                    ),
                                    "c",
                                ),
                                IntLiteral(1),
            ...
            [
                FuncDecl(
                    ...
                    Block(
                        [
                            Return(None),
                            Return(BinaryOp("+", FuncCall("foo", []), IntLiteral(2))),
                        ]
                    ),
                )
            ]
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            ...
                            MethCall(Id("a"), "foo", []),
                            MethCall(
                                FieldAccess(ArrayCell(Id("a"), [IntLiteral(2)]), "c"),
                                "foo",
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            ...
                            If(
                                BinaryOp("+", IntLiteral(1), IntLiteral(1)),
                                Block([Return(IntLiteral(1)), Return(None)]),
                                None,
                            ),
                        ]
                    ),
            ...
            [
                FuncDecl(
                    ...
                    Block(
                        [
                            ForBasic(
                                ArrayCell(FieldAccess(Id("a"), "i"), [IntLiteral(8)]),
                                Block([Return(None), Return(IntLiteral(1))]),
                            ),
                            ForStep(
                                Assign(Id("i"), IntLiteral(0)),
                                BinaryOp(
                                    "<",
                                    ArrayCell(Id("i"), [IntLiteral(1)]),
                                    IntLiteral(10),
                                ),
                                Assign(
                                    Id("i"),
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            MethCall(
                                ArrayCell(
                                    FieldAccess(FieldAccess(Id("a"), "b"), "c"),
                                    [IntLiteral(2)],
                                ),
                                "d",
                                [],
...
"""
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            ...
                            Return(StringLiteral('"THANKS YOU, PPL1 "')),
                        ]
                    ),
                )
            ]
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    StructLiteral(
                        "STRUCT", [("a", IntLiteral(1)), ("b", BooleanLiteral(False))]
                    ),
                )
            ]
        )
    ...
    def test_112(self):
        ...
        expect = Program(
            [
                ConstDecl(
                    "VoTien", None, ArrayLiteral([Id("ID")], IntType(), [IntLiteral(1)])
                )
            ]
        )
        self.assertTrue(
            ...
            [
                ConstDecl(
                    ...
                    ArrayLiteral(
                        [IntLiteral(1), IntLiteral(2)],
                        IntType(),
                        [FloatLiteral("1."), StructLiteral("STRUCT", []), NilLiteral()],
                    ),
                )
            ]
        )
            ...
            [
                ConstDecl(
                    ...
                    ArrayLiteral(
                        [IntLiteral(1), IntLiteral(2)],
                        Id("STRUCT"),
                        [[IntLiteral(1), [IntLiteral(3)]], [IntLiteral(2)]],
                    ),
                )
            ]
        )
    ...
    def test_125(self):
        ...
        expect = Program(
            [
                ConstDecl(
                    "VoTien", None, ArrayCell(Id("a"), [IntLiteral(2), IntLiteral(3)])
                )
            ]
        )
        self.assertTrue(
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    None,
                    MethCall(
                        MethCall(Id("a"), "b", []), "c", [IntLiteral(1), IntLiteral(2)]
                    ),
                )
            ]
        )
        ...
        expect = Program(
            [
                ConstDecl(
                    ...
                    MethCall(
                        FieldAccess(
                            ArrayCell(FieldAccess(Id("a"), "b"), [IntLiteral(2)]), "c"
                        ),
                        "d",
                        [],
                    ),
...
"""
        expect = Program(
            [
                ...
                VarDecl(
                    "a", ArrayType([Id("ID"), IntLiteral(1)], IntType()), IntLiteral(1)
                ),
            ]
        )
        self.assertTrue(
            ...
            [
                StructType(
                    ...
                    [
                        ("a", IntType()),
                        ("b", Id("ID")),
                        ("c", ArrayType([IntLiteral(2)], IntType())),
                    ],
                    [],
                )
            ]
...
"""
        expect = Program(
            [
                FuncDecl(
                    "foo", [], VoidType(), Block([VarDecl("a", None, IntLiteral(1))])
                ),
                FuncDecl(
                    "foo", [], IntType(), Block([VarDecl("a", None, IntLiteral(1))])
                ),
                FuncDecl(
                    "foo",
                    [],
                    ArrayType([IntLiteral(2)], Id("ID")),
...
"""
        expect = Program(
            [
                ...
                FuncDecl(
                    "foo",
                    [ParamDecl("a", IntType()), ParamDecl("b", Id("ID"))],
                    VoidType(),
                    Block([VarDecl("a", None, IntLiteral(1))]),
                ),
                FuncDecl(
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [],
                    VoidType(),
                    Block([Continue(), Break(), Return(None), Return(IntLiteral(1))]),
                )
            ]
        )
        self.assertTrue(
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            ...
                            VarDecl(
                                "a",
                                ArrayType([Id("ID"), IntLiteral(1)], IntType()),
                                IntLiteral(1),
                            ),
                ...
                FuncDecl(
                    ...
                    Block(
                        [
                            ...
                            Assign(
                                FieldAccess(Id("a"), "b"),
                                BinaryOp("-", FieldAccess(Id("a"), "b"), IntLiteral(5)),
                            ),
                            Assign(
                                ArrayCell(
                                    FieldAccess(
        ...
        expect = Program(
            [
                FuncDecl(
                    ...
                    [],
                    VoidType(),
                    Block([ForBasic(IntLiteral(1), Block([Return(None)]))]),
                )
            ]
        )
        self.assertTrue(
            ...
            [
                FuncDecl(
                    ...
                    Block(
                        [
                            ForEach(
                                Id("a"), Id("b"), IntLiteral(2), Block([Return(None)])
                            )
                        ]
                    ),
                )
